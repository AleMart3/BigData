...
public class Bigramma implements WritableComparable<Bigramma>{
	...
	public Bigramma(Text text1, Text text2) {
		 this.text1 = text1;
		 this.text2 = text2;
		 }
